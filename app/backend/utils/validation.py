...
def extract_issue_date_from_warning(warning_file_path):
    ...
    try:
        ...
        for line in lines:  # Check first 5 lines
            line = line.strip()
            if line:
...
def validate_date_range_match(metar_file_path, warning_file_path):
    ...
    print("Extracted issue date string:", issue_date_str)
    ...
    try:
        ...
        print("Range:", range_start, "to", range_end)
        ...
        print("First METAR timestamp:", metar_timestamps[:5])
